...
<body>
    ...
    <?php
        if (array_key_exists("caption", $_GET)) {
            $query_image = mysqli_query($db, 'SELECT * FROM photo WHERE caption LIKE "%' . $_GET["caption"] . '%" ');
        } else {
            $query_image = mysqli_query($db, 'SELECT * FROM photo');
        }
        ...
        <div class="photo">
            ...
            <div class="photo__info">
                <div class="photo__actions">
                    ...
                    <span class="photo__action">
                        <i class="fa fa-comment-o fa-lg"></i><br>
                    </span>
                </div>
                <span class="photo__likes"><?= $images["like"]  ?> like</span>
                <span class="caption"><?= $images["caption"] ?></span>
